...
import crispy.kmerdist.KmerDistMapper;
...
public class Kmer extends Configured implements Tool {
	...
	// implement Tools
	// hadoop jar Kmer.jar crispy.Kmer <working-directory> <output-directory> <blocks> <inputFasta>
	...
	BalanceIndexMapper.assign(inputFasta, inputIndex, blocks);
        ...
        job1.setJarByClass(Kmer.class);
        job1.setJobName("CalculateKmerDist");
        ...
        job1.setMapperClass(KmerDistMapper.class);
